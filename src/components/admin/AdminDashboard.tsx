...
function ProductCreateForm({ onClose, onCreated }: { onClose: () => void; onCreated: (product: AdminProduct) => void }) {
  ...
  return <div className="rounded-2xl border border-brand-cyan/30 bg-brand-dark-card p-5">
    ...
    <form aria-label="Crear producto" id="product-create-form" onSubmit={submit} className="grid grid-cols-1 gap-4 md:grid-cols-2">
      <label className={labelClass}>Nombre en español<input id="product-create-name_es" name="name_es" required minLength={2} className={inputClass} /></label>
      <label className={labelClass}>Nombre en inglés<input id="product-create-name_en" name="name_en" required minLength={2} className={inputClass} /></label>
      ...
      <label className={`${labelClass} md:col-span-2`}>Descripción en español<textarea id="product-create-description_es" name="description_es" rows={3} className={inputClass} /></label>
      <label className={`${labelClass} md:col-span-2`}>Descripción en inglés<textarea id="product-create-description_en" name="description_en" rows={3} className={inputClass} /></label>
...
function ProductEditForm({ product, onClose, onSaved }: { product: AdminProduct; onClose: () => void; onSaved: (product: AdminProduct) => void }) {
  ...
  return <div className="rounded-2xl border border-brand-orange/30 bg-brand-dark-card p-5"><div className="mb-4 flex justify-between"><h3 className="font-heading font-bold">Editar {product.name_es}</h3><button onClick={onClose} aria-label="Cerrar edición de producto"><X className="h-5 w-5" /></button></div>
